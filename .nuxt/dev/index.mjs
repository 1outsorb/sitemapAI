...
import destr, { destr as destr$1 } from 'file:///Users/sunbangheng/Desktop/sitemapAI/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/sunbangheng/Desktop/sitemapAI/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/sunbangheng/Desktop/sitemapAI/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/sunbangheng/Desktop/sitemapAI/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/sunbangheng/Desktop/sitemapAI/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/sunbangheng/Desktop/sitemapAI/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/sunbangheng/Desktop/sitemapAI/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/sunbangheng/Desktop/sitemapAI/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/sunbangheng/Desktop/sitemapAI/node_modules/defu/dist/defu.mjs';
...
import { SourceMapConsumer } from 'file:///Users/sunbangheng/Desktop/sitemapAI/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/sunbangheng/Desktop/sitemapAI/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/sunbangheng/Desktop/sitemapAI/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/sunbangheng/Desktop/sitemapAI/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///Users/sunbangheng/Desktop/sitemapAI/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/sunbangheng/Desktop/sitemapAI/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/sunbangheng/Desktop/sitemapAI/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/sunbangheng/Desktop/sitemapAI/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/sunbangheng/Desktop/sitemapAI/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/sunbangheng/Desktop/sitemapAI","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/sunbangheng/Desktop/sitemapAI/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/sunbangheng/Desktop/sitemapAI/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/sunbangheng/Desktop/sitemapAI/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/sunbangheng/Desktop/sitemapAI/.data/kv"}));
...
const _uSuxMCl2FJ3XS5LaOp4dH1pTHVL1_EQ0Unn1nbvS8 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/sunbangheng/Desktop/sitemapAI";
...
const _6lVuWhkF2eJVjqCDKfeT6CfuEkr5roQhDqS8JIdc3JA = (nitroApp) => {
...
const plugins = [
  _uSuxMCl2FJ3XS5LaOp4dH1pTHVL1_EQ0Unn1nbvS8,
...
const _MpXLvc = eventHandler((event) => {
...
const getServerEntry = () => import('file:///Users/sunbangheng/Desktop/sitemapAI/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/sunbangheng/Desktop/sitemapAI/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
